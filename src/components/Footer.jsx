      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-purple-200 text-sm leading-6 mt-5 max-w-xs">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#5b2bbf] transition"
              >
                <FaFacebookF size={13} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  to="/"
                  className="text-purple-200 text-sm hover:text-white hover:underline underline-offset-8 transition-all"
                >
                  Home
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="/about"
                  className="text-purple-200 text-sm hover:text-white hover:underline underline-offset-8 transition-all duration-300"
                >
                  About Us
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="/contact"
                  className="text-purple-200 text-sm hover:text-white transition-all hover:underline underline-offset-8 duration-300"
                >
                  Contact
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="w-8 h-8 shrink-0 rounded-full bg-white/10 flex items-center justify-center text-purple-200">
                  <FaMapMarkerAlt size={12} />
                </div>

                <p className="text-purple-200 text-sm leading-5">
                  Dhaka, Bangladesh
                </p>
      ...
      <div className="border-t border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-5">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <p className="text-purple-300 text-xs text-center md:text-left">
